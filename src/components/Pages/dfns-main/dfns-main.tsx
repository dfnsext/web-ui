		...
		return (
			<div class="root" data-visible={router.state.route ? "visible" : "hidden"}>
				...
				<div class="content">
					...
					{router.state.route === RouteType.RECOVERY_SETUP && <dfns-recovery-setup></dfns-recovery-setup>}
					{router.state.route === RouteType.VALIDATE_WALLET && (
						<dfns-validate-wallet network={this.network}></dfns-validate-wallet>
					)}
